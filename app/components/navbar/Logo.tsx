...
export default function Logo() {
  return (
    <Link href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
      {/* Mascot Icon */}
      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-primary hover:scale-105 transition-transform duration-200">
        <svg
          viewBox="0 0 20 20"
      ...
      <span className="hidden text-xl font-bold tracking-tight sm:block">
        ...
        <span className="text-primary font-black uppercase tracking-wide">Blogs</span>
      </span>
    </Link>
  );
}
