    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-8">
        ...
        <nav className="flex items-center gap-1.5 text-xs text-muted mb-6 animate-fade-in-up">
          ...
          <Link
            href={post.category === 'linux' || post.category === 'windows' ? `/os/${post.category}` : `/${post.category}`}
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-muted border-b border-border pb-4">
                <div className="flex items-center gap-1.5">
                  <div className="h-5 w-5 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white text-[8px] font-black">
                    GM
                  </div>
          ...
          <aside className="space-y-6 animate-fade-in-up">
            ...
            <div className="rounded-xl border border-border bg-card p-5 sticky top-20">
              <div className="flex items-center gap-3 pb-4 border-b border-border">
                <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-black">
                  GM
                </div>
                <div>
